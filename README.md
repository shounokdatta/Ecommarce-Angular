...
## 🚀 Live Demo
You can view the deployed version here: [ecommarce-angular-2.onrender.com](https://ecommarce-angular-2.onrender.com/home)
...
### 1. Clone the repository
```bash
git clone [https://github.com/shounokdatta/Ecommarce-Angular.git](https://github.com/shounokdatta/Ecommarce-Angular.git)
